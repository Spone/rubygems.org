module Rstuf
  class Client
    ...
    def self.delete_artifacts(targets)
      # DELETE request doesn't support body, this will be fixed in RSTUF API soon
      # for that reason connection.delete can't bude used in here, since it will skip the body
      response = connection.run_request(:delete, "/api/v1/artifacts/", { targets: targets }, {})
